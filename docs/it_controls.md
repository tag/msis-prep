...
**You should understand the different types of IT controls, as well as when it is best to respectively apply them.** Furthermore, have a basic understanding of the primary IT Control frameworks which can be utilized when developing solutions.

1. Describe the components of the IT Risk Triad (CIA): _**Confidentiality**_, _**Integrity**_, and _**Availability**_.
...
- **ITGC:** General controls are implemented as procedures or policies. Because they are often enforced by people, compliance may vary. There are several subcategories/domains/systems of general controls, including:
...
- **ITAC:** Application control are enforced by technology rather than by policy. Enterprises work with huge volumes of data, so automatically enforced controls are necessary to keep data error-free.
    ...
    Application controls help manage other features of data, including bias, timeliness, shareability, and security. In addition to enforcing data controls, there are many other purposes of application controls, including access control and encryption. For example, a two-factor authentication requirement built into web or software systems is an application control.
...
- **Corrective**: Homeowners Insurance
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/tWBPo--PzO4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
Read ["What Are The Differences Between COBIT & COSO"](https://reciprocitylabs.com/what-are-the-differences-between-cobit-coso/) to understand the differences between the two frameworks.

#### Exercises

1. What is the purpose of IT controls? Why do you think it is necessary for companies to have formal controls?
2. What is the difference between general controls and application controls?
3. List the several characteristics of data. Are these characteristics best enforced by general controls or application controls?
4. In your own words, describe the three types of IT controls while providing an example for each:
5. Explain how the following frameworks and legislation relate to IT controls:
    1. COSO
    2. COBIT
    3. SOX
